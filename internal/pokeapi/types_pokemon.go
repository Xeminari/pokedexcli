...
type PastTypesTypesType struct {
	Name string `json:"name"`
	URL  string `json:"url"`
}
type PastTypesTypes struct {
	Slot               int                `json:"slot"`
	PastTypesTypesType PastTypesTypesType `json:"type"`
}
type PastTypes struct {
	Generation     Generation       `json:"generation"`
	PastTypesTypes []PastTypesTypes `json:"types"`
}
type PastAbilitiesGeneration struct {
	Name string `json:"name"`
	URL  string `json:"url"`
}
...
type PastAbilities struct {
	PastAbilitiesGeneration PastAbilitiesGeneration  `json:"generation"`
